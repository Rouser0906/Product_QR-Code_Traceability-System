...
Write-ULog "INFO" "监控目录: $LocalA"
Write-ULog "INFO" "监控目录: $LocalB"
...
# 启动文件监控
$aWatcher = Start-FileWatcher $LocalA "A"
$zyWatcher = Start-FileWatcher $LocalB "B"
