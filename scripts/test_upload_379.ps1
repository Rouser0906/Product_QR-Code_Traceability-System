Write-Host "Testing upload of HS-DEMO-000009379.json..." -ForegroundColor Yellow

$FtpServer = "10.0.0.100"
$FtpUser = "your_ftp_username"
$FtpPassword = "[REDACTED-FTP-PASSWORD]"
$LocalFile = "C:\Projects\Demo\cloud\demo_json_a\HS-DEMO-000009379.json"
$RemoteUrl = "ftp://10.0.0.100/companies/demo_json_a/HS-DEMO-000009379.json"
...
try {
    if (Test-Path $LocalFile) {
        ...
        Write-Host "SUCCESS: HS-DEMO-000009379.json uploaded successfully!" -ForegroundColor Green
    } else {
