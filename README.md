...
| 版本 | 价格 | 内容 | 获取方式 |
|---|---|---|---|
| **开源版** | 免费 | 完整源码、自行部署 | `git clone` 本仓库，或右上角 `Code → Download ZIP` |
| **标准版** | ¥299 | Windows 打包程序（exe + 安装器）+ 1 年版本更新 + 邮件支持 | [爱发电](https://afdian.net/a/Rouser0906) |
| **企业版** | ¥999 | 标准版全部 + 多公司/高级报表/品牌定制 + 部署指导 + 优先支持 | [爱发电](https://afdian.net/a/Rouser0906) |
| **定制开发** | ≥¥3000（面议） | 二次开发 / 私有部署 / 培训 | 联系作者 |

> **源码永久免费开源**。付费版卖的是「打包好的可执行程序 + 持续更新 + 技术支持 + 定制服务」——省去你自己搭环境、打包、排错的时间。想免费使用？直接用源码自行构建（见 [打包桌面应用](#打包桌面应用)）。
>
> 🛒 标准版 / 企业版经 **爱发电（afdian.net）** 自动发货；购买入口：https://afdian.net/a/Rouser0906 （标准版/企业版数字商品陆续上架）
