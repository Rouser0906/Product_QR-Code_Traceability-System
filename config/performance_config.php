...
define('PRELOAD_PRODUCTS', [
    'A-DEMO-000008704', 'A-DEMO-000008705', 'A-DEMO-0001',
    'B-DEMO-000000001', 'B-DEMO-000000005', 'B-DEMO-000000006'
]);

/**
 * 根据产品代码获取远端配置（A-Q..., B-Q...）
 */
function get_ftp_config($product_code) {
    if (strpos($product_code, 'A-Q') === 0) {
        return FTP_SERVERS['A'];
    } elseif (strpos($product_code, 'B-Q') === 0) {
        return FTP_SERVERS['B'];
    }
    return null;
}
