...
## 问题现象
- 移动端扫码 `https://scan.example.com/index.html?code=A-DEMO-000000001`  
- 表现：空白页 / 无法连接 / 提示“网络错误”  
...
3. PowerShell 执行：
```powershell
Invoke-WebRequest https://scan.example.com/index.html?code=A-DEMO-000000001 -Headers @{'User-Agent'='Mozilla/5.0 (Linux; Android 13) Chrome/112.0.0.0 Mobile'} -UseBasicParsing
```
返回 200 即闭环。